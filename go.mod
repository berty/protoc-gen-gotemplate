...
require (
	...
	golang.org/x/crypto v0.0.0-20190422085530-df01cb2cc480 // indirect
	golang.org/x/sync v0.0.0-20190422085530-56d357773e84 // indirect
	google.golang.org/genproto v0.0.0-20190422085530-e7d98fc518a7
